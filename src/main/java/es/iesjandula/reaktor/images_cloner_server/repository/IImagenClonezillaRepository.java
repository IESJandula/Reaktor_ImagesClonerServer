...
public interface IImagenClonezillaRepository extends JpaRepository<ImagenClonezilla, String>
{
	 ...
	 * @param estado Estado de la imagen.
	...
	/**
	 * Busca todas las imágenes Clonezilla por estado ordenadas por nombre de imagen.
	 * @param estado Estado de la imagen.
	 * @return Lista de imágenes Clonezilla.
	 */
	@Query("SELECT new es.iesjandula.reaktor.images_cloner_server.dto.ImagenClonezillaDto(i.nombreImagen, i.estado) FROM ImagenClonezilla i WHERE i.estado = :estado ORDER BY i.nombreImagen ASC")
